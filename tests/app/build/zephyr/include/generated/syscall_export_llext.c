...
extern __weak ALIAS_OF(no_handler) void * const z_impl_ztest_set_fault_valid;
extern __weak ALIAS_OF(no_handler) void * const z_impl_ztest_set_assert_valid;
extern __weak ALIAS_OF(no_handler) void * const z_impl_ztest_run_test_suites;
extern __weak ALIAS_OF(no_handler) void * const z_impl___ztest_set_test_result;
extern __weak ALIAS_OF(no_handler) void * const z_impl___ztest_set_test_phase;
extern __weak ALIAS_OF(no_handler) void * const z_impl_z_test_1cpu_start;
extern __weak ALIAS_OF(no_handler) void * const z_impl_z_test_1cpu_stop;
extern __weak ALIAS_OF(no_handler) void * const z_impl_sys_clock_tick_set;
